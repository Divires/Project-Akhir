                        ...
                        @php
                            $books = [
                                [
                                    ...
                                    'stok' => 12,
                                    'gambar' => 'https://ebooks.gramedia.com/ebook-covers/73131/image_highres/BLK_RPL2022573544.jpg',
                                ],
                                [
                                    'kode' => 'B002',
                                    'judul' => 'Mastering PHP',
                                    'stok' => 8,
                                    'gambar' => 'https://bintangpustaka.com/wp-content/uploads/2022/06/REKAYASA-PERANGKAT-LUNAK_FRONTCOVER.png',
                                ],
                                [
                                    'kode' => 'B003',
                        ...
                        @foreach ($books as $book)
                            <tr class="h-20">
                                ...
                                <td class="px-4 flex justify-center items-center gap-5 text-lg py-8">
                                    ...
                                    <a href="/editbuku" aria-label="Edit" class="text-[#2d4fb1] hover:text-[#1f3a7e] transition">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-width="2">
                                            <path
