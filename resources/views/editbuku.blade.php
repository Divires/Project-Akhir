        ...
        <div class="overflow-x-auto border border-[#e2e2e2] rounded-lg p-6 bg-white text-sm shadow w-full">
            <form class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="kode" name="kode" value="B001"
                ...
                <div>
                    ...
                    <input type="text" id="judul" name="judul" value="Laravel untuk Pemula"
                        class="w-full h-10 border border-[#e2e2e2] rounded px-3 focus:outline-none focus:ring-2 focus:ring-[#2d4fb1]"
                ...
                <div>
                    ...
                    <input type="number" id="stok" name="stok" value="12"
                        class="w-full h-10 border border-[#e2e2e2] rounded px-3 focus:outline-none focus:ring-2 focus:ring-[#2d4fb1]"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="deskripsi" name="deskripsi" rows="4"
                        ...
                        placeholder="Masukkan deskripsi buku">Buku ini menjelaskan dasar Laravel dari awal hingga menengah.</textarea>
                </div>
