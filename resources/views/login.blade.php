...
<body class="bg-gray-50 flex items-center justify-center min-h-screen p-4">
  <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-md flex flex-col items-center">
    ...
    <!-- Form Login -->
    <form class="w-full flex flex-col gap-5" onsubmit="event.preventDefault(); window.location.href='/dashboard';">
      <h2 class="text-[#2c2c2c] text-xl font-semibold mb-4 text-center">Login</h2>
    ...
    <p class="mt-6 text-[#a1a0a0] text-center text-sm">
      Belum punya akun?
      <a href="/register" class="text-[#2d4fb1] font-semibold hover:underline">Daftar</a>
    </p>
  </div>
